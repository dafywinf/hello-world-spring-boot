package com.dafywinf.hello;

import com.dafywinf.core.config.CRLFLogConverter;
...
public class HelloWorldSpringApplication {
  ...
  public HelloWorldSpringApplication(Environment env) {
    this.env = env;
  }

  public static void main(String[] args) {
    SpringApplication app = new SpringApplication(HelloWorldSpringApplication.class);

    // Sets the "dev" profile as default
